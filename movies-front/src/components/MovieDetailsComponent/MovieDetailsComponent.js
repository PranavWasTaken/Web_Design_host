            ...
            return (
                <AnimatedDiv style={{
                    ...
                    <div className="container mt-2">
                        ...
                        <br/>
                        <h3 className="white-title">Reviewer Reviews</h3>
                        {
                            this.state.reviews.length === 0 &&
                            <p className="white-title">No Reviewers have reviewed this movie</p>
                        }
                    ...
                    <AnimatedDiv style={{
                        ...
                        <div className="container mt-4">
                            ...
                            <div className="row">
                                <div className="col-md-3 col-xs-1">
                                    ...
                                    {"\n"}
                                    {
                                        ...
                                        <button className="btn w-100 btn-outline-primary" onClick={this.handleStream}>Strem Online</button>
                                    }
                                </div>
                            ...
                            </div>
                            {
                                ...
                                <div className="card shadow p-3 text-white rounded " style={{backgroundColor:""}}>
                                    <h5>ADD A REVIEW</h5>
                                    <input className="card mb-2 mt-2 p-3 border" name="title"
                                           onChange={this.reviewTitleEdited}
                                           placeholder="Review Title"/>
                                    <textarea className="card border mb-2 p-3" name="body"
                ...
                return (
                    <AnimatedDiv style={{
                        ...
                        <div className="container mt-4">
                            ...
                            <br/>
                            <h3 className="white-title">Reviewer Reviews</h3>
                            <p className="white-title">No Reviewer have reviewed this movie</p>
                            {
                                this.state.userProfile !== undefined &&
                                this.state.userProfile.type === 'critic' &&
